...
fun HomeView(
    ...
    Scaffold(
        ...
        topBar = {AppBarView(title= "EASY TASK MANAGEMENT",)},
        ...
        Column {
            // Image
            Image(
                painter = painterResource(id = R.drawable.hi), // Replace "your_image_resource" with the actual resource ID of your image
            ...
            LazyColumn(
                ...
                items(todolist.value, key = { wish -> wish.id }) { todo ->
